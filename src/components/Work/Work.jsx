...
const Work = () => {
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {projects.map((project) => (
          <div
            ...
            className="backlight shadowlight border border-white bg-gray-900 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden cursor-pointer hover:shadow-purple-500/50 hover:-translate-y-2 transition-transform duration-300"
          >
            <div className="p-4">
              <img
                src={project.image}
            ...
            <div className="p-6">
              <h3 className="paralight text-2xl font-bold text-white mb-2">
                {project.title}
              </h3>
              <p className="paralight text-gray-500 mb-4 pt-4 line-clamp-3">
                {project.description}
              </p>
              <div className="mb-4">
      ...
      {/* Modal Container */}
      {selectedProject && (
        <div className="popbacklight fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4 overflow-auto">
          <div className="popbacklight bg-gray-900 rounded-xl shadow-2xl mt-60  w-[90%] max-w-3xl  relative">
            ...
            <div className="flex flex-col">
              <div className="popbacklight w-full flex justify-center bg-gray-900 px-4">
                <img
              ...
              <div className="lg:p-8 p-6">
                <h3 className="paralight lg:text-3xl font-bold text-white mb-4 text-md">
                  {selectedProject.title}
                </h3>
                <p className="paralight text-gray-400 mb-6 lg:text-base text-xs">
